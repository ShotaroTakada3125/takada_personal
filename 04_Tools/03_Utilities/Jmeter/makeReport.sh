...
BASE_DIR="/Users/takada/Desktop/takada_personal/toiware_task/adamas_ST/results/0114"
...
do
    ...
    # sort -t, -k1,1n ${JTL_FILE} | TZ='Asia/Tokyo' gawk -F, '$3 == "30_ログイン処理(/api/login-1067)" {print strftime("%Y-%m-%d %H:%M:%S", $1/1000)}'
    if [ $? -eq 0 ]; then
